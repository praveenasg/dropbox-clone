  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#2B2929] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-5">
          ...
          <p className="pb-20">
            ...
            efficcient way to upload, organize, and access files from anywhere.
          ...
          <Link
            href="/dashboard"
            className="flex cursor-pointer bg-blue-500 p-5 w-fit hover:bg-blue-400"
          >
            Try if for free
      ...
      <p className="text-center font-light p-2">
        This website is made for informational and educational purposes only. I
        do not own or affiliate with Dropor or/and any of its subsidiaries in
        any form.
      </p>
    </main>
  );
